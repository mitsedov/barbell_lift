...
**It is easy to see that the model is quite accurate with 95% confidence interval being (0.999, 1).** This speaks in favour of low out-of-sample error, which is expected to be lower than 0.1%.
...
In this report a machine learing algorithm (Generalized Boosted Regression Model) was used to build a classifier for barbell lifting patterns. An impressive accuracy, lying in (0.999, 1) with 95% confidence was achieved under cross-validation.
